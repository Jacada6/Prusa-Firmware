...
//MB CHANGE -  change it to 1 to reverse!
...
//MB CHANGE + 500
#define DEFAULT_MAX_ACCELERATION            {1500, 1500, 300, 5000}  // (mm/sec^2) max acceleration (M201)
#define DEFAULT_MAX_ACCELERATION_SILENT     {960, 960, 200, 5000}    // (mm/sec^2) max acceleration (M201), silent mode


#define DEFAULT_ACCELERATION          1750   // X, Y, Z and E max acceleration in mm/s^2 for printing moves (M204P)
#define DEFAULT_RETRACT_ACCELERATION  1750   // X, Y, Z and E max acceleration in mm/s^2 for retracts (M204R)
...
//Normal mode limits
#define NORMAL_MAX_ACCEL_XY     3500ul  // max acceleration in normal mode in mm/s^2
...
#define EXTRUDER_ALTFAN_SPEED_SILENT 192
